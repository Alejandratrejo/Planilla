...
public class Empleado_Planilla_Matriz {
    ...
    public static void main(String[] args) {
      Scanner entrada=new Scanner(System.in);
       ...
       for (int i=0; i<10; i++)
       { System.out.print(i+1 +"el nombre del empleado  ");
       ...
       //planilla[10][7]=(int)(Math.random()*9+3);//sueldo liquido \***/
           System.out.print("codigo      nombre            sueldo base     bonificacion    comiciones    iggs     desceuntos jud      Isr      SUeldo liquido" );
            for(int i=0; i<10; i++){
                System.out.println();
           System.out.print(planilla[i][0] +"            "+nombre_empleado[i]+"                "+planilla[i][1] +   "            "+planilla[i][2] +"            "+planilla[i][3] +"         "+planilla[i][4] +"           "+planilla[i][5] +"             "+planilla[i][6]); }
       }}
